...
int isascii(int);
int toascii(int);
# 5 "Proj_Principal.c" 2

# 1 "./Configuration_Header_File.h" 1
# 10 "./Configuration_Header_File.h"
...
# 10 "./Configuration_Header_File.h" 2
...
# 6 "Proj_Principal.c" 2

# 1 "./ADC_Header_File.h" 1
# 11 "./ADC_Header_File.h"
int ADC_Read(int channel);
void ADC_Init();
# 7 "Proj_Principal.c" 2
...
void USART_Init(int);
# 8 "Proj_Principal.c" 2

# 1 "./LCD_16x2_8-bit_Header_File.h" 1
# 19 "./LCD_16x2_8-bit_Header_File.h"
void LCD_Init();
...
# 9 "Proj_Principal.c" 2

# 1 "./EEPROM_Header_File.h" 1
# 11 "./EEPROM_Header_File.h"
void EEPROM_Write(int,char);
char EEPROM_Read(int);
void EEPROM_WriteString(int,char*);
# 10 "Proj_Principal.c" 2
...
char TempInterna[10];
char TempExterna[10];
char TempExteAtivacao[10];
char TempInternaIdeal[10];
...
__attribute__((picinterrupt(("high_priority")))) void ISR1(void) {
    if (RCIF) {
        while (RCIF == 0);
        char res = RCREG;
        if (res == 'I') {
